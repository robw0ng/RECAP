 ...
 *   https://datatables.net/download/#bs5-5.3.0/jq-3.7.0/dt-2.1.4/sc-2.4.3
 *
 * Included libraries:
 *   Bootstrap 5 5.3.0, jQuery 3 3.7.0, DataTables 2.1.4, Scroller 2.4.3
 */
...
(function( factory ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		builder: "bs5-5.3.0/jq-3.7.0/dt-2.1.4/sc-2.4.3",
